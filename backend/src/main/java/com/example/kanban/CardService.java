...
public class CardService {
  ...
  public CardResponse moveCard(Long cardId, CardMoveRequest request) {
    ...
    Column targetColumn =
        columnRepository
            ...
            .orElseThrow(
                () ->
                    new ResponseStatusException(
                        HttpStatus.NOT_FOUND, "Column not found: " + request.columnId()));
    ...
    if (sameColumn) {
      ...
      List<Card> targetSiblings =
          cardRepository.findByColumnIdOrderByPositionAsc(request.columnId());
  ...
  public List<CardResponse> sortColumnByDueDate(Long columnId) {
    columnRepository
        ...
        .orElseThrow(
            () ->
                new ResponseStatusException(HttpStatus.NOT_FOUND, "Column not found: " + columnId));
