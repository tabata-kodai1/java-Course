...
public class CardController {
  ...
  public CardResponse createCard(
      @PathVariable Long columnId, @Valid @RequestBody CardCreateRequest request) {
    return cardService.createCard(columnId, request);
  }

  @PatchMapping("/api/cards/{cardId}")
  public CardResponse updateCard(
      @PathVariable Long cardId, @Valid @RequestBody CardUpdateRequest request) {
  ...
  public CardResponse moveCard(
      @PathVariable Long cardId, @Valid @RequestBody CardMoveRequest request) {
